// These IRcodes are default for the DirecTV remote model RC73 (also known as a Genie remote and has RF)

//    See GLC_SampleIRcodes for a few other known remotes and their codes or 
//      use GLC_GetIRcodes to find the codes of another remote.
...
#define ENTER_BUTTON        0x3F23F43     // button at the bottom right of the number pad "enter"
...
#define FORWARD_RIGHT       0x34498102  // on this remote using the "Exit" button near the Select button
#define FORWARD_RT_ALT      0x0
#define FORWARD_LEFT        0x81A840E6  // on this remote using the "R" button near the Select button
#define FORWARD_LFT_ALT     0x0
#define BACKWARD_RIGHT      0xF640360  // on this remote using the Red dot button near the Select button
#define BACKWARD_RT_ALT     0x0
#define BACKWARD_LEFT       0xC332FABB  // on this remote using the "Info" button near the Select button
